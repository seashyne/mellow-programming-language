...
STDLIB_CALLS = {
    "print": "std.io.println",
    "println": "std.io.println",
    "write": "std.io.write",
    "input": "std.io.input",
    "readline": "std.io.input",
    "read_line": "std.io.input",
    "ask": "std.io.input",
    "args": "std.sys.args",
    "argv": "std.sys.args",
    "cwd": "std.sys.cwd",
    "sleep_ms": "std.sys.sleep_ms",
    "exit": "std.sys.exit",
    "gc_collect": "std.gc.collect",
    "gc_stats": "std.gc.stats",
    "spawn": "std.thread.spawn",
    "yield": "std.thread.yield",
    "channel": "std.chan.channel",
    "send": "std.chan.send",
    "recv": "std.chan.recv",
    "len": "std.len",
    "str": "std.type.to_str",
