...
## Fixes
- Fix: `mellow doctor` / `mellow explain` now work (no duplicate subcommand parser + command is recognized in modern CLI mode).

## Notes
- No language/syntax changes from v1.2.0.
