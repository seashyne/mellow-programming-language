...
sudo dpkg -i dist/mellowlang_2.5.0_amd64.deb
mellow --version
```
...
# then double-click dist/MellowLang-2.5.0.pkg
# or: sudo installer -pkg dist/MellowLang-2.5.0.pkg -target /
mellow --version
```
...
Double-click `MellowLang_Setup_2.5.0.exe` -> Next -> Install.

Two installer variants:
| File | Size | Notes |
|---|---|---|
| `MellowLang_Setup_2.5.0.exe` | ~25 MB | onedir - fast startup |
| `MellowLang_Setup_2.5.0_portable.exe` | ~12 MB | onefile - single portable .exe |
...
|---|---|---|
| Windows onedir | `build_exe.bat` | `dist/MellowLang_Setup_2.5.0.exe` |
| Windows onefile | `build_exe.bat` | `dist/MellowLang_Setup_2.5.0_portable.exe` |
| macOS | `bash packaging/macos/build_pkg.sh` | `dist/MellowLang-2.5.0.pkg` |
| Linux .deb | `bash packaging/linux/build_deb.sh` | `dist/mellowlang_2.5.0_amd64.deb` |
