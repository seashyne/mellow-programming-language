...
| `src/mellowlang/compiler/legacy.py` | `_compile_get_module()`, `GetModuleExpr` in expr compiler |
| `src/mellowlang/vm/cbridge.py` | Full Python fallback for all opcodes |
| `src/mellowlang/host/legacy.py` | Extended AI allowlist, `register_ai_functions()` |
